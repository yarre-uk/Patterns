...
namespace Flyweight
{
    ...
    public class Flyweight_
    {
        private Car _sharedState;

        public Flyweight_(Car car)
        {
            _sharedState = car;
        }
    ...
    {
        private List<Tuple<Flyweight_, string>> flyweights = new List<Tuple<Flyweight_, string>>();

        public FlyweightFactory(params Car[] args)
        {
            foreach (var elem in args)
            {
                flyweights.Add(new Tuple<Flyweight_, string>(new Flyweight_(elem), getKey(elem)));
            }
        }
        ...
        // новый.
        public Flyweight_ GetFlyweight(Car sharedState)
        {
            ...
            if (flyweights.Where(t => t.Item2 == key).Count() == 0)
            {
                ...
                flyweights.Add(new Tuple<Flyweight_, string>(new Flyweight_(sharedState), key));
            }
            else
            {
