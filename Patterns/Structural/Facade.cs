namespace Facade
{
    ...
    public class Facade_
    {
        ...
        public Facade_(Subsystem1 subsystem1, Subsystem2 subsystem2)
        {
    ...
    class Client
    {
        ...
        public static void ClientCode(Facade_ facade)
        {
    ...
    class Facade
    {
        public static void Start()
        {
            ...
            Facade_ facade = new Facade_(subsystem1, subsystem2);
